...
static boolean
WritePressKey(byte channel, byte key,
...
static boolean
WriteReleaseKey(byte channel, byte key,
                MEMFILE *midioutput) {
...
static boolean
WritePitchWheel(byte channel, short wheel,
                MEMFILE *midioutput) {
...
static boolean
WriteChangePatch(byte channel, byte patch,
                 MEMFILE *midioutput) {
