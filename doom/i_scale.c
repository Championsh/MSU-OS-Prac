...
static inline void
WriteBlendedLine1x(byte *dest, byte *src1, byte *src2,
                   byte *stretch_table) {
    int x;
...
static inline void
WriteBlendedLine2x(byte *dest, byte *src1, byte *src2,
                   byte *stretch_table) {
    int x;
    int val;
...
static inline void
WriteBlendedLine3x(byte *dest, byte *src1, byte *src2,
                   byte *stretch_table) {
    int x;
    int val;
...
static inline void
WriteBlendedLine4x(byte *dest, byte *src1, byte *src2,
                   byte *stretch_table) {
    int x;
    int val;
